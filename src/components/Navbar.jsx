...
const Navbar = () => {
  ...
  return (
    <>
      <div className="navbar bg-base-100 items-center justify-between shadow-md z-10 fixed top-0">
        <div className="flex-1">
          <a className="btn btn-ghost normal-case text-xl md:text-center">OTA</a>
        </div>
